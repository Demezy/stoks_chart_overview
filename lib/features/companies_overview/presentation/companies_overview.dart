...
class CompaniesOverview extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final companyesDetails = ref.watch(companyDetalesUpdaterProvider);
    if (companyesDetails.isEmpty) {
          ...
          child: PieChart(
            PieChartData(
              pieTouchData: PieTouchData(
                touchCallback: (event, pieTouchResponse) {
                  ...
                  if (event is FlTapUpEvent) {
                    context.push(
                      Routes.detales,
                      extra: companyesDetails[sectionIndex],
                    );
                  }
                },
              ),
              ...
              sections: List<PieChartSectionData>.generate(
                companyesDetails.length,
                (index) {
                  final companyDetail = companyesDetails[index];
